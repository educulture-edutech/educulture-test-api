...
exports.paymentSuccess = async (req, res) => {
    ...
    try {
        let payment = await Payment.findOneAndUpdate({referenceId: referenceId, paymentType: paymentType}, 
            {$set: {paymentId: paymentId, transactionId: transactionId, paymentStatus: "success" }}, 
            {new: true});
